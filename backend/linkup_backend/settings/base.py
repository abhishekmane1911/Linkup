"""
Base Django settings for linkup_backend project.
"""
...
MIDDLEWARE = [
    ...
    "apps.common.middleware.AbusePreventionMiddleware",
    "apps.common.middleware.APIVersionMiddleware",
]
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'linkup.log',
            'formatter': 'verbose',
        },
        'console': {
            'level': 'INFO',
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_CLASSES': [
        'apps.common.throttling.IPBasedThrottle',
        'apps.common.throttling.CustomUserRateThrottle',
        'apps.common.throttling.BurstThrottle',
        'apps.common.throttling.SustainedThrottle'
    ],
